...
export const register = catchAsyncErrors(async (req, res, next) => {
  try {
    ...
    if (req.files && req.files.resume) {
      ...
      if (resume) {
        try {
          // Log file details to ensure it's being uploaded correctly
          console.log("Uploading resume:", resume.tempFilePath);
          
          const aryResponse = await cloudinary.uploader.upload(
            resume.tempFilePath,
          ...
          // Assign Cloudinary public_id and URL to userData
          userData.resume = {
            public_id: cloudinaryResponse.public_id,
            url: cloudinaryResponse.secure_url,
          };
          
          console.log("Resume uploaded successfully:", cloudinaryResponse.secure_url);
        } catch (error) {
